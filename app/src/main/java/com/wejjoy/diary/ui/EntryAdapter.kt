...
import com.wejjoy.diary.data.dayCount
import com.wejjoy.diary.data.dayIndexOf
import com.wejjoy.diary.data.endDay
import com.wejjoy.diary.data.isMultiDay
import com.wejjoy.diary.databinding.ItemEntryBinding
...
class EntryAdapter(
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        val authorPrefix = if (e.authorName.isNotBlank()) "[${e.authorName}] " else ""
        b.entryTitle.text = authorPrefix + e.title.ifBlank { "(제목 없음)" } +
